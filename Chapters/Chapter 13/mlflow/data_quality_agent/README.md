...
## Files
- `src/mlflow_model_registry/data_quality_agent.py`: Main agent and MLflow wrapper implementation.
...
The 'mlflow_model_registry' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/mlflow_model_registry/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] mlflow_model_registry_job` to your workspace.
